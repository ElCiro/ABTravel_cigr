			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="<?php $value["ruta_articulo"]; ?>"><h5 class="d-block d-lg-none py-3"><?php echo $value["titulo_articulo"]; ?></h5></a>
			
						<a href="<?php echo $value["ruta_articulo"]; ?>"><img src="<?php echo $value["portada_articulo"]; ?>" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%"></a>
