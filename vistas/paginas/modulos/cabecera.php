	...
	<div class="container p-0">
		...
		<div class="row">
			...
			<div class="col-10 col-sm-11 col-md-8 pt-1 pt-lg-3 p-xl-0">
				<a href="<?php echo $blog_cigr["dominio"]; ?>">	
					<img src="<?php echo $blog_cigr["logo"]; ?>" alt="Logo de ABTravel" 
			...
			<div class="d-none d-md-block col-md-2 redes">
				...
				<?php 
					$redesSociales = json_decode($blog_cigr["redes_sociales"], true);
					//echo '<pre class="bg-white">'; print_r($redes_sociales); echo '</pre>';
					foreach ($redesSociales as $key => $value) {
						echo '<li>
							<a href="'.$value["url"].'" target="_blank">
								<i class="'.$value["icono"].' lead rounded-circle text-white 
								mr-1"></i>
							</a>
						</li>'; 
					}
